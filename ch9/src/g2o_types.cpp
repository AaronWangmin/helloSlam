...
{
    const g2o::VertexPointXYZ* point = static_cast<g2o::VertexPointXYZ*>(_vertices[0]);
...
EdgeProjectXYZRGBD::linearizeOplus()
{
...
void EdgeProjectXYZUVPoseOnly::computeError()
{
    const g2o::VertexSE3Expmap* pose = static_cast<g2o::VertexSE3Expmap*>(_vertices[0]);
...
void EdgeProjectXYZUVPoseOnly::linearizeOplus()
{
    g2o::VertexSE3Expmap* pose = static_cast<g2o::VertexSE3Expmap>(_vertices[0]);
    g2o::SE3Quat T(pose->estimate());
    Vector3d xyz_trans = T.map(point_);
